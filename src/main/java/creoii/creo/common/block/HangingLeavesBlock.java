...
public class HangingLeavesBlock extends Block implements Fertilizable {
    ...
    public VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        return state.get(HALF) == Half.UPPER ? LARGE_SHAPE : SMALL_SHAPE;
    }
    ...
    public void neighborUpdate(BlockState state, World world, BlockPos pos, Block block, BlockPos fromPos, boolean notify) {
        world.setBlockState(pos, state.with(HALF, world.getBlockState(pos.down()).getBlock() == this ? Half.UPPER : Half.LOWER));
    }
